...
const ReadDownload = () => {
  ...
  const getDataapicall = () => {
    axios.get(`${BaseUrl}/documents/get/readdownload/${params.type}`).then((res) => {
...
const params=useParams();
  ...
  const columns = [
      ...
      },
    {
      ...
      render: (text, record) => {
        const utcDateTime = new Date(record.createtime); // Assuming CREATED_AT contains UTC time
